...
public class MineScenario extends RandomSpeedBase {
    private static ModuleInfo info;
    
    static {
        info = new ModuleInfo("MineScenario");
	...
	public MineScenario(int nodes, double x, double y, double duration, double ignore, long randomSeed, double minspeed, double maxspeed, double maxpause, double maxdist, double avgMobileNodesPerGroup, double groupSizeDeviation, double pGroupChange) {
	...
	public MineScenario( String[] args ) {
		for (int i = 0; i < 5; i++) { // for each type of area
			obstacles[i] = new LinkedList<Obstacle>();
		}
		go( args );
